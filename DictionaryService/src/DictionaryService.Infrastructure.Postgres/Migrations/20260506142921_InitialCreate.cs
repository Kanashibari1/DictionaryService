        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    hierarchy_path = table.Column<string>(type: "character varying(2048)", maxLength: 2048, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    office_number = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("pk_department_positions", x => new { x.department_id, x.post_id });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "fk_department_positions_post_id",
                        column: x => x.post_id,
            ...
            migrationBuilder.CreateIndex(
                name: "ix_department_positions_post_id",
                table: "department_positions",
                column: "post_id");

            migrationBuilder.CreateIndex(
                name: "ix_departments_hierarchy_path",
                table: "departments",
